...
#graf(X1, Y1, z, X, Y, Z, WID, HEI, title="Bilinear", font_size=20.0, pad=20.0, ty=1)
#%%
...
anim(X1, Y1, z, X, Y, Z, WID, HEI, frames=200, title="Lagrange", save_path=sp_a, interval=50, font_size=20.0, pad=20.0, ty=1)
# %%
